...
public class HouseController extends BaseController {
  ...
  @ResponseBody
  public ResponseData repair(@RequestParam(required = false, value = "pic1") MultipartFile pic1, @RequestParam(required = false, value = "pic2") MultipartFile pic2,
      @RequestParam(required = false, value = "pic3") MultipartFile pic3, HttpServletRequest request, HttpServletResponse response) {
    log.debug("in repair");
    ResponseData data = new ResponseData();
